...
<h6 class="card-subtitle text-muted"></h6>
            ...
            <div class="button-list">
                ...
                <div class="spread">
                    ...
                    @if ($next)
                        <a href="{{ route('post', $next->slug) }}" class="">
						<button type="button" class="btn btn-bordered-primary waves-effect width-xs waves-light" style="height:28px;font-size:12px;font-weight:bold">Next Post</button>
                        </a>
                    @endif
                </div>
            </div></h6>
